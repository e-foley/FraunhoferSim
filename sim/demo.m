...
psfCut(c11_psf, cut_plot_props, IoProps);
cut_plot_props.labels = {'bowtie mask'};
psfCut(bowtie_psf, cut_plot_props, IoProps);
...
psfPlot([c11_psf bowtie_psf], psf_plot_props, IoProps);
...
psfCut([c11_psf bowtie_psf], cut_plot_props, IoProps);
...
svPlot(c11_sv, sv_plot_props, IoProps);
sv_plot_props.plot_title = 'Monochromatic view of stars through bowtie mask';
svPlot(bowtie_sv, sv_plot_props, IoProps);
